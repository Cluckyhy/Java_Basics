package com.chy.mhl.view;

import com.chy.mhl.domain.*;
import com.chy.mhl.service.BillService;
import com.chy.mhl.service.DiningTableService;
import com.chy.mhl.service.EmployeeService;
import com.chy.mhl.service.MenuService;
import com.chy.mhl.utils.Utility;
...
public class MHLView {
    ...
    public void orderDiningTable() {
        ...
        if (key == 'Y') {     //要预定
            //根据orderId 返回 对应的 DiningTable对象，如果为null，说明对象不存在
            ...
            if (!("空".equals(diningTable.getState()))) {      //说明当前这个餐桌不是"空" 的状态
                System.out.println("=============该餐桌已经预定或则就餐中=============");
                return;
            }
            //这时说明可以真的预定了，更新餐桌的状态
            //接收预定信息
            System.out.println("预定人的姓名：");
            ...
            switch (key) {
                case "1":
                    ...
                    if (employee != null) {   //说明存在该用户
                        ...
                        //显示二级菜单，这里的二级菜单是循环操作，所以做成while
                        while (loop) {
                            System.out.print("=============满汉楼(二级菜单)=============\n");
