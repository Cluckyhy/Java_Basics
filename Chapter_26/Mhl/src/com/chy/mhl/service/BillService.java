...
import com.chy.mhl.dao.BillDAO;
import com.chy.mhl.dao.MultiTableDAO;
import com.chy.mhl.domain.Bill;
import com.chy.mhl.domain.MultiTableBean;
...
public class BillService {
    ...
    public boolean payBill(int diningTableId, String payMode){
        ...
        //2、修改diningTable表
        //注意不要直接在这里操作，而应该调用DiningTableService 方法，完成更新，体现各司其职
